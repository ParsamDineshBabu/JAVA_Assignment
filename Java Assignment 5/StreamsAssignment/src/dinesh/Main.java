...
public class Main{
    public static void main(String[]args){    
    	...
    	List<Fruit> fru=Arrays.asList(
    			new Fruit("Apple",98,45,"Gray"),
    			new Fruit("Watermelon",102,30,"Green"),
    			new Fruit("Pineapple",120,55,"Gray"),
    			new Fruit("Orange",78,34,"Yellow"));
    	
    	
    	List<News> news1=Arrays.asList(
    			new News(15,"Dinesh","Babu","life cycle"),
    			new News(16,"Sai","P","ipl"),
    			new News(16,"Sai","P","Bang Bang"),
    			new News(17,"Chinna","Ganesh","Hi"),
    			new News(15,"Dinesh","Suresh","Hello"),
    			new News(16,"Sai","P","India Won The Game"));
    	
        Trader soomesh = new Trader("Dine", "HYD");
        Trader suresh = new Trader("Sweety","Bangalore");
        Trader abhi = new Trader("Venkat","HYD");
        Trader sai = new Trader("Murgan","HYD");

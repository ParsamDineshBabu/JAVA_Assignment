...
class Movie 
{
	public static void main(String[] args) {
		...
		List<Movie_Details> movie = Arrays.asList(new Movie_Details("Nani", "Mahesh", "Chinna", "Action"),
				new Movie_Details("Three", "Dhanush", "Dinesh", "Adventure"));
